...
function buttonClick() {
  const filteredMenu = this.dataset.id === "All" ? menu : menu.filter((item) => item.category === this.dataset.id);
  addMenu(filteredMenu);
}

// Menü bilgilerini ekleme
function addMenu(displayMenu) {
...
// Sayfa açıldığında tüm menüyü gösterme
addMenu(menu);
